        ...
        <div className="container mx-auto max-w-6xl">
          <ScrollReveal>
            <div className="grid md:grid-cols-2 gap-8 items-center mb-16">
              <div className="bg-card/50 backdrop-blur-sm border-2 border-primary/30 rounded-3xl p-8 sm:p-10 hover:border-primary/40 transition-all duration-300 shadow-lg text-center sm:text-left">
                ...
                <div className="space-y-4">
                  <p className="text-base sm:text-lg text-muted-foreground leading-relaxed font-varela text-center sm:text-justify">
          ...
          <ScrollReveal>
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="bg-card/50 backdrop-blur-sm border-2 border-primary/30 rounded-3xl p-8 sm:p-10 hover:border-primary/40 transition-all duration-300 shadow-lg order-1 md:order-2 text-center sm:text-left">
                <div className="space-y-4">
                  <p className="text-base sm:text-lg text-muted-foreground leading-relaxed font-varela text-center sm:text-justify">
