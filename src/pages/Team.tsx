              ...
              <div className="bg-card/50 backdrop-blur-sm border-2 border-primary/30 rounded-2xl p-8 sm:p-10 hover-lift shadow-lg">
                ...
                <div className="pt-6 border-t border-foreground/10">
                  <a 
                    ...
                    className="inline-block text-base sm:text-xl font-varela text-primary hover:text-primary-glow transition-colors duration-300 cursor-hover relative group"
                  >
