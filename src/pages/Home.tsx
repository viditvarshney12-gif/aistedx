  ...
  return (
    <div className="min-h-screen bg-background mobile-safe-area">
      ...
      <section className="relative h-[55vh] md:h-[90vh] lg:h-screen flex items-center justify-center overflow-hidden">
        ...
        {/* Content */}
        <div className="relative z-10 container mx-auto px-4 text-center h-full md:block">
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            ...
            >
              ...
              <span className="hidden md:inline-block md:absolute md:bottom-32 md:left-1/2 md:-translate-x-1/2">
      ...
      <ScrollReveal>
        <section className="py-20 sm:py-24 md:py-28 px-4 bg-gradient-to-b from-background/50 to-background">
          <div className="container mx-auto text-center max-w-4xl">
            ...
            >
              <div className="flex flex-row items-center justify-center gap-4 sm:gap-8 flex-nowrap scale-90 xs:scale-95 sm:scale-100">
